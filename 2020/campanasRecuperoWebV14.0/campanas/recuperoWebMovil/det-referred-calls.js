var controller = {
    ...
    init: function (container, options) {
        ...
        thisController.setTooltipsOnColumnHeader($("#listaReferidos"), 2, "OU (Outbound), IN (Inbound), WE (Web).");
        thisController.setTooltipsOnColumnHeader($("#listaReferidos"), 3, "RWF (Recupero Web Fijo), RWM (Recupero Web Móvil)");
