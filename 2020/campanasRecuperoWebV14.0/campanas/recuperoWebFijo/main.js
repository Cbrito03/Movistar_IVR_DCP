    ...
    init: function (container, options) {
        ...
        var mainArea = this.$this.find("#mainArea").zPager({
            pages: [
                ...
                { code: "call", url: "campanas/recuperoWebFijo/en-llamada", initial: (campana.estado == "call" || campana.estado == "preview") }
            ],
            onReady: function () {
        ...
        whenAutoloadReady("al-botonera", function () {
            ...
            thisController.botoneraController.loadWrapUpCodes("RW-FIJO");
        ...
        if (campana.estado == "call" || campana.estado == 'preview') {
            ...
            if (info != null) {
                ...
                if (estadoFinalizacion == thisController.idGrupoAgenda) {
                    ...
                    cicTrace("[recuperoFijo][finaliza] Antes de invocar SegundaParteFinalizar");
                    thisController.SegundaParteFinalizar(info, estadoFinalizacion, codFinalizacion, fechaAgendada, cmdFinalizar);
                    cicTrace("[recuperoFijo][finaliza] Despues de invocar SegundaParteFinalizar");
                }              
