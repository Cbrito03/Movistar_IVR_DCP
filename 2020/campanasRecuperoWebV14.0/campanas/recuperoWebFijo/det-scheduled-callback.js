var controller = {
    ...
    init: function (container, options) {
        ...
        thisController.setTooltipsOnColumnHeader($("#listaAgendados"), 2, "OU (Outbound), IN (Inbound), WE (Web).");
        thisController.setTooltipsOnColumnHeader($("#listaAgendados"), 3, "RWF (Recupero Web Fijo), RWM (Recupero Web Móvil)");
