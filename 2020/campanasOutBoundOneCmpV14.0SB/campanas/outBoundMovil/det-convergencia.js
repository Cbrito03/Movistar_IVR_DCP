var controller = {
    ...
    getConvergencia: function () {
        ...
        if (!cliente.nombreCli) {
            showMsgBoxAlert("Debe ingresar el 'Nombre Cliente' en la pesta\u00f1a Clientes antes de generar una Convergencia","Cliente No Ingresado");
            thisController.$this.find("#edConvergencia").removeAttr("checked");
            return;
        } else {
		...
		if (!cliente.numeroCli) {
		    ...
		    if (numeroLength > 6) {
		        showMsgBoxAlert("Excedi\u00F3 largo permitido para el numero de direcci\u00F3n, \n por favor modifique numero de direcci\u00F3n en pesta\u00f1a Cliente","Validación Dirección")
		        thisController.$this.find("#edConvergencia").removeAttr("checked");
		        return;
		    }
		}
        ...
        if (!cliente.calleCli) {
            ...
            if (calleLength > 40) {
                showMsgBoxAlert("Excedi\u00F3 largo permitido para calle, \n por favor modifique calle en pesta\u00f1a Cliente","Validación Ingresada")
                thisController.$this.find("#edConvergencia").removeAttr("checked");
                return;
        ...
        if (!cliente.regionCli) {
            ...
            if (regionLength > 20) {
                showMsgBoxAlert("Excedi\u00F3 largo permitido para regi\u00F3n, \n por favor modifique regi\u00F3n en pesta\u00f1a Cliente","Validación Región")
                thisController.$this.find("#edConvergencia").removeAttr("checked");
                return;
            }
        }
