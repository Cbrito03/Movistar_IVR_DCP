...
var controller = {
    ...
    init: function (container, options) {
        ...
        thisController.$this.find(".telefono").blur(function () {
            ...
            if (!$(this).inputmask("isComplete")) {
                showMsgBoxAlert("El telefono debe contener 9 dígitos");
        ...
        thisController.$this.find("#edEmail").blur(function () {
            ...
            if (!re.test($(this).val())) {
                showMsgBoxAlert("El formato de email no es válido");
                $(this).val("");
            }
        });
    ...
    refresca: function () {
        ...
        thisController.$this.find("#edNombrePagador").val(cicGetGenerico02());//cliente pagador
        thisController.$this.find("#edRutPagador").val(cicGetGenerico03());//cliente pagador
   ...
   setActiveTabs: function (index) {
    ...
    enviarReferido: function () {
        ...
        if (!telefono) {
            showMsgBoxAlert("Debe ingresar Fono para ingresar un Cliente Referido ");
            return;
        } else if (telefono.length < 9) {
            showMsgBoxAlert("El Telefono debe contenter 9 Dígitos");
            return;
        }

        if (!nombre) {
            showMsgBoxAlert("Debe ingresar Nombre para ingresar un Cliente Referido ");
            return;
        }
    ...
    calculaEdadCliente: function(esRespaldo){
        ...
        if (thisController.isDate(txtVal)) {
            if (!thisController.isMayorEdad(txtVal)) {
                showMsgBoxAlert("No se puede vender a Clientes menores de edad");
            ...
            if (thisController.isTerceraEdad(txtVal)) {
                showMsgBoxAlert("No se puede vender a Clientes con más de 70 años");
                thisController.$this.find("#edEdad" + (esRespaldo ? "Resp" : "")).val("");
            ...
            showMsgBoxAlert('Fecha No Válida, debe ingresar Fecha de Nacimiento correcta');
            thisController.$this.find("#edEdad" + (esRespaldo ? "Resp" : "")).val("");
            return;
        }
    ...
    getCliente: function () {
        ...
        if (thisController.$this.find("#edClienteRespaldo").is(':checked')) {
            ...
            cliente.nombrePagador = thisController.$this.find("#edNombrePagador").val();
            cliente.rutPagador = thisController.$this.find("#edRutPagador").val();
