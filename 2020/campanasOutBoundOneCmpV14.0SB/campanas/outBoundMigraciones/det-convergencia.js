var controller = {
	...
	thisController.$this.find("#convComunaDesc").attr("disabled", "disabled");
        ...
        var cmdGenerarConvergenciaF = thisController.$this.find("#edConvergenciaF");
        var cmdGenerarConvergenciaM = thisController.$this.find("#edConvergenciaM");
        ...
        cmdGenerarConvergenciaF.click(function () {
            ...
            if (checkConvergenciaM != "1") {
                ...
                if (checkConvergenciaF = "0" && VerificacionDatos) {
        ...
        cmdGenerarConvergenciaM.click(function () {
            ...
            if (checkConvergenciaF != "1") {
                ...
                if (checkConvergenciaM = "0" && VerificacionDatos) {
                    thisController.$this.find("#ConvNombreCliente").val("");
                    thisController.$this.find("#convComuna").val("");
                    thisController.$this.find("#ConvCalleResp").val("");
                    thisController.$this.find("#ConvNumeroResp").val("");
    ...
    getConvergencia: function () {
        ...
        if (!cliente.nombreCli) {
            showMsgBoxAlert("Debe ingresar el 'Nombre Cliente' en la pesta\u00f1a Clientes antes de generar una Convergencia", "Nombre Cliente No Ingresado");
            thisController.$this.find("#edConvergenciaM").removeAttr("checked");
            thisController.$this.find("#edConvergenciaF").removeAttr("checked");
            return;
        } else {
        ...
        if (!cliente.numeroCli) {
            ...
            if (numeroLength > 6) {
                showMsgBoxAlert("Excedi\u00F3 largo permitido para el numero de direcci\u00F3n, \n por favor modifique numero de direcci\u00F3n en pesta\u00f1a Cliente", "Validación Direccion")
                thisController.$this.find("#edConvergenciaM").removeAttr("checked");
                thisController.$this.find("#edConvergenciaF").removeAttr("checked");
                return;
            }
        ...
        if (!cliente.regionCli) {
            showMsgBoxAlert("Debe ingresar la 'Regi\u00f3n' en la pesta\u00f1a Clientes  antes de generar una Convergencia", "Región No Ingresada");
            thisController.$this.find("#edConvergenciaM").removeAttr("checked");
            thisController.$this.find("#edConvergenciaF").removeAttr("checked");
            return;
        } else {
            ...
            if (regionLength > 20) {
                showMsgBoxAlert("Excedi\u00F3 largo permitido para regi\u00F3n, \n por favor modifique regi\u00F3n en pesta\u00f1a Cliente", "Validación Cliente")
                thisController.$this.find("#edConvergenciaM").removeAttr("checked");
                thisController.$this.find("#edConvergenciaF").removeAttr("checked");
                return;
            }
        ...
        if (!cliente.comunaCli) {
            ...
            if (comunaLength > 40) {
                showMsgBoxAlert("Excedi\u00F3 largo permitido para comuna, \n por favor modifique comuna en pesta\u00f1a Cliente", "Validación Comuna");
                thisController.$this.find("#edConvergenciaM").removeAttr("checked");
                thisController.$this.find("#edConvergenciaF").removeAttr("checked");
                return;
            }
