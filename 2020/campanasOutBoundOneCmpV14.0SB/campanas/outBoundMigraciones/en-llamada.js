var controller = {
    ...
    init: function (container, options) {
        ...
        whenAutoloadReady("al-cierre", function () {
            ...
            thisController.cierreController.onSwitchOffEnviadoBO = function () { thisController.onSwitchOffEnviadoBO(); }
    ...
    getInfoGestion: function (idGestion) {
        var thisController = this;

        cicTrace("GetInfoGestion para ID: " + idGestion);

        httpInvoke("getGestion.ges", { idGestion: parseInt(idGestion) }, function (infoGestion) {

            cicTrace("Refresca Info segun ID: " + idGestion);

            thisController.clienteController.refresca(infoGestion.infoCliente);
            thisController.ofertaController.refresca(infoGestion.infoOfertas);
            thisController.datosAdicionalesController.refresca();
            thisController.gestionVentaController.refresca(infoGestion.infoGestionVenta);

            var infoCierre = infoGestion.infoCierre;
            infoCierre.observacionVenta = infoGestion.infoGestionVenta.observaciones;
            infoCierre.listaProductosParrilla = infoGestion.infoGestionVenta.listaProductosParrilla;
            infoCierre.infoCliente = infoGestion.infoCliente;
            

            thisController.cierreController.refresca(infoCierre);
