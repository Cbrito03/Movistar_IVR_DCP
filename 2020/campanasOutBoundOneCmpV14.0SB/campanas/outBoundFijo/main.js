    ...
    init: function (container, options) {
        ...
        var mainArea = this.$this.find("#mainArea").zPager({
            pages: [
                ...
                { code: "call", url: "campanas/outBoundFijo/en-llamada", initial: (campana.estado == "call" || campana.estado == "preview")}
            ],
            onReady: function () {
        ...
        clearTimeout(thisController.botoneraController.msgCierreLlamadaTimeOut);
           thisController.botoneraController.msgCierreLlamadaTimeOut = null;
            ...
            thisController.botoneraController.loadWrapUpCodes("FIJO");
...
clearTimeout(thisController.botoneraController.deshabilitarrediscado);
        ...
        if (info) {
            ...
            if (info.infoGestion.despReferencia) {
                ...
                if (referenciaLength > 200) {
                    showMsgBoxAlert("Excedió largo permitido para la referencia de la dirección", "Validación Referencia Direccioón");
                    return;
                }
            }
            ...
            if (info.infoGestion.accResp1) {
                ...
                if (resp1Length > 200) {
                    showMsgBoxAlert("Excedió largo permitido para la respuesta N°1", "Validación Respuesta N°1");
                    return;
                }
            ...
            if (info.infoGestion.accResp2) {
                ...
                if (resp2Length > 200) {
                    showMsgBoxAlert("Excedió largo permitido para la respuesta N°2", "Valdación respuesta N°2");
                    return;
                }
 ...
 // showMsgBoxAlert("Codigo Automatico:"+estadoFinalizacion);
           ...
           thisController.botoneraController.msgCierreLlamadaTimeOut = null;
            ...
            if (finalizaConVenta && !thisController.enviadoBO) {
                showMsgBoxAlert("Debe enviar a BackOffice los cambios en Ficha de Cierre","Validacion Ficha de Cierre");
                return;
            }
           ...
           thisController.botoneraController.msgCierreLlamadaTimeOut = null;
                ...
                if (intentosDisponibles <= 0) {
                    showMsgBoxAlert("No es posible realizar un agendamiento debido a que se ha alcanzado el máximo de llamadas permitidas [" + thisController.botoneraController.nroMaximoLlamadas + "]", "Validación Agendamiento");
 ...
 clearTimeout(thisController.botoneraController.deshabilitarrediscado);
           ...
           thisController.botoneraController.msgCierreLlamadaTimeOut = null;
            ...
            if (info) {
                ...
                if (info.infoGestion.despReferencia) {
                    var referenciaLength = info.infoGestion.despReferencia.length;
                    if (referenciaLength > 200) {
                        showMsgBoxAlert("Excedió largo permitido para la referencia de la dirección", "Validacion Referncia de Direccón")
                        return;
                    }
                }
                ...
                if (info.infoGestion.accResp1) {
                    var resp1Length = info.infoGestion.accResp1.length;
                    if (resp1Length > 200) {
                        showMsgBoxAlert("Excedió largo permitido para la respuesta N°1", "Validacón Respuesta N°1")
                        return;
                    }
                ...
                if (info.infoGestion.accResp2) {
                    var resp2Length = info.infoGestion.accResp2.length;
                    if (resp2Length > 200) {
                        showMsgBoxAlert("Excedió largo permitido para la respuesta N°2", "Validacón Respuesta N°2")
                        return;
                    }
    ...
    getDataGestion: function (esFinalizar, recuperaDatosFicha, isAutomatic) {
        var thisController = this;
        ...
        if (recuperaDatosFicha) {
            ...
            if (!infoCierre.infoCliente.nombre) {
                ...
                if (cliLength > 100) {
                    showMsgBoxAlert("Excedió largo permitido para el nombre del Cliente", "Validación Nombre Cliente")
                    return null;
                }
            }
            ...
            if (!infoCierre.infoCliente.ciclo) {
                showMsgBoxAlert("En la Ficha de Cierre 'Ciclo de Facturación' es obligatorio", "Ciclo de Facturacón No Ingresado");
                return null;
            }
            if (!infoCierre.infoDespacho.nombre) {
                showMsgBoxAlert("En la Ficha de Cierre 'Nombre Persona Contactar' es obligatorio", "Nombre Persona a Contactar No Ingresado");
                return null;
            }
            if (!infoCierre.infoCliente.calle) {
                showMsgBoxAlert("En la Ficha de Cierre 'Calle' es obligatorio", "Calle No Ingresado");
                return;
            } else {
                var calleLength = infoCierre.infoCliente.calle.length;
                if (calleLength > 40) {
                    showMsgBoxAlert("Excedió largo permitido para  Calle", "Validacón Calle");
                    return;
                }
            }
            if (!infoCierre.infoCliente.region) {
                showMsgBoxAlert("En la Ficha de Cierre 'Región' es obligatorio", "Región No Ingresado");
                return;
            } else {
                var regionLength = infoCierre.infoCliente.region.length;
                if (regionLength > 20) {
                    showMsgBoxAlert("Excedió largo permitido para Región", "Validacion Región");
                    return;
                }
            }
            ...
            if (infoCierre.infoCliente.entreCalle) {
                ...
                if (entreCalleLength > 40) {
                    showMsgBoxAlert("Excedió largo permitido para Entre Calle", "Validación Entre Calle");
                    return null;
            ...
            if (infoCierre.infoCliente.numero) {
                ...
                if (numeroLength > 6) {
                    showMsgBoxAlert("Excedió largo permitido para número de dirección particular", "Validación dirección particular");
                    return null;
            ...
            if (infoCierre.infoCliente.yCalle) {
                ...
                if (calleLength > 40) {
                    showMsgBoxAlert("Excedió largo permitido para y Calle", "Validación y Calle");
                    return null;
                }
        ...
        infoGestion.phoneNumber = cicGetAccLineaId();//modificado de    infoGestion.phoneNumber = cicGetNumberToDial();   16072018 
        infoGestion.toExclude = cicGetToExclude();
        infoGestion.expiration = cicGetExpiration();
        infoGestion.fbackRegId = "";
        infoGestion.fbackLinea = cicGetAccLineaId(); //modificado de    infoGestion.phoneNumber = cicGetNumberToDial();   16072018 
        ...
        if (recuperaDatosFicha) {
            if (infoCierre.infoVentaParrillas.length > 0) {
                ...
                infoPreventa.seguro = "";
                infoPreventa.grupoIse = infoVenta.grupoIse;
                infoPreventa.limiteCredito = infoVenta.limiteCredito;
                infoPreventa.dMapas = infoVenta.dMapas;
                infoPreventa.d21 = infoVenta.d21;
