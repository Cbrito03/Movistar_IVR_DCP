...
function cicGetCampaignName() { return "CMP_CL_OV_OU_FIJ"; }
...
function cicGetAccCampanaId() { return "CQC Mov VtaFija" }
function cicGetAccHorario() { return "0" }
function cicGetAccScore() { return "0.75" }
function cicGetAccPreg1() { return "Que productos Fijo tiene con la competencia?" }
...
function cicGetCallFamiliaId() { return "FIJ" } 
...
function cicGetNumberToDial() { return "998447675" }
...
function cicGetSbxGenerico1() { return "TBL_CL_OV_OU_FIJ" } //TBL_TEST_QA_MOV002
