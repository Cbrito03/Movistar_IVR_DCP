...
function cicSetGenerico15(value) {
    IS_Attr_GENERICO_15.value = value;
    return true;
}

function cicSetGenerico16(value) {
    IS_Attr_GENERICO_16.value = value;
    return true;
}

// Acciones
function cicPickup(callId) {
    if (callId) IS_Action_Pickup.CallID = callId;
...
function cicHold(callId) {
    if (callId) {
        IS_Action_Hold.CallID = callId;
    }
