    ...
    callObject: {
        ...
        getAttribute: function (attr) {
            ...
            if (attr == "ATTR_PAIS") {
                ...
                return "CMP_CO_DI_IN_NR";
            } else if (attr == "ATTR_TABLENAME") {
                return "TBL_CO_DI_IN_NR";
            } else if (attr == "ATTR_CONTACTLIST") {
                return "CTL_CO_DI_IN_NR";
                ...
                return "Cliente Vigente Móvil Hogar";
            }
...
function cicGetGenerico17() {
    if (app.isInboundCall) return "";
    return "Cliente Vigente Fijo Hogar";
}
...
function cicSetSbxGenerico17(valor) { cicDBGlog("Set cicSetSbxGenerico17:" + valor); }
