var controller = {
    ...
    refresca: function () {
        ...
        httpInvoke("getReferidos.ges", { campaignName: (infoMetadataObject ? infoMetadataObject.i3Campaignname : cicGetCampaignName()), ejecutivo: cicGetSystemAgentId() }, function (ret) {
