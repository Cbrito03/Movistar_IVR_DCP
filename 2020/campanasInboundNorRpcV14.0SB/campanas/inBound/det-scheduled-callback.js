var controller = {
    ...
    refresca: function () {
        ...
        var infoMetadataObject = thisController.onGetMetaDataObject();

        httpInvoke("getAgendados.ges", { campaignName: (infoMetadataObject ? infoMetadataObject.i3Campaignname : cicGetCampaignName()), ejecutivo: cicGetSystemAgentId() }, function (ret) {
