var controller = {
    ...
    refresca: function () {
        ...
        thisController.$this.find("#edEmail").val(cicGetGenerico04());
        var html = "";

        thisController.$this.find("#edDireccion").val(cicGetGenerico05());
    ...
    getCliente: function () {
        ...
        cliente.direccionCli = thisController.$this.find("#edDireccion").val();
