...
{
    var postData = {
        "ID_llamada" : "123456890",
        "num_cliente" : "527151275151", // Telefono
        "ticket" : "300007247501",
        "estatus" : "0000",
    ...
    httpReporteIVRDCP(postData, function (resp)
    {
        ...
        {
           alert("No se logro generar el reporte. " + resp.detalle);
        }
    },function (error)
    {
        alert("No se logro generar el reporte. " + error.detalle);
        console.log("ONBlur :: error :: ", error);
    });
});
...
{    
    return $.ajax({
        ...
        success: function (jRet)
        {
            ...
            console.log("success :: ret :: ", ret, typeof ret);
